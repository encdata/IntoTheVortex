...
public record TardisData(UUID id, UUID ownerId, UUID exteriorId, String exterior, String interior, String dimension, BlockPos position, float yaw, boolean locked, boolean doorOpen, boolean interiorInitialized) {
    ...
    public TardisData withExterior(UUID exteriorId) {
        return new TardisData(id, ownerId, exteriorId, exterior, interior, dimension, position, yaw, locked, doorOpen, interiorInitialized);
    }
    ...
    public TardisData withInteriorInitialized(boolean value) {
        return new TardisData(id, ownerId, exteriorId, exterior, interior, dimension, position, yaw, locked, doorOpen, value);
    }

    public TardisData withInterior(String value) {
        return new TardisData(id, ownerId, exteriorId, exterior, value, dimension, position, yaw, locked, doorOpen, false);
    }
}
